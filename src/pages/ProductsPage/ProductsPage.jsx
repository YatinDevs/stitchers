    ...
    <div className="mt-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight text-[#d81b60]">
          Our <span className="text-[#ff4081]">Product Range</span>
        </h1>
      ...
      >
        {categories.map((category, index) => (
          <motion.div
            key={index}
            variants={fadeIn}
            className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border border-gray-200"
          >
            ...
            <div className="p-6">
              ...
              <Link
                to={category.link}
                className="text-[#ff4081] font-medium hover:underline inline-flex items-center"
              >
                View Collection
                <svg
      ...
      >
        ...
        >
          {[
            ...
            <div
              key={index}
              className="bg-[#fce4ec] p-6 rounded-lg h-full flex flex-col items-center"
            >
      ...
      >
        ...
        <Link
          to="/contact"
          className="bg-white text-[#d81b60] font-medium py-2 px-6 rounded-md hover:bg-[#fce4ec] transition-colors inline-block"
        >
          Get in Touch
        </Link>
      </motion.div>
